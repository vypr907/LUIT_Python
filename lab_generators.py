# defining the char_range generator here
...
assert isgeneratorfunction(
    char_range
    ), f"Expected char)range to be a generator function but was not."
    
#ensure that the result *does* include the stop character
...
#step properly if a step value is provided
